...
public class RatioLayout62 extends FrameLayout {
	...
	public RatioLayout62(Context context) {
		this(context, null);
	}

	public RatioLayout62(Context context, AttributeSet attrs) {
		super(context, attrs);

		TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.RatioLayout62);

		mPicRatio = typedArray.getFloat(R.styleable.RatioLayout62_picRatio, 0);

		mRelative = typedArray.getInt(R.styleable.RatioLayout62_relative, RELATIVE_WIDTH);
