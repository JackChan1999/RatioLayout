...
public class RatioLayout66 extends FrameLayout {
	// 宽和高的比例
	private float ratio = 0.0f;

	public RatioLayout66(Context context) {
		this(context, null);
	}

	public RatioLayout66(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RatioLayout66(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RatioLayout66);
		ratio = a.getFloat(R.styleable.RatioLayout66_ratio, 0.0f);
		a.recycle();
	}
